...
@Component
public class BoletoAlteradoStrategyImpl implements EventTypeStrategy {

    private final EventProcessor<BoletoNegativado> processor;

    public BoletoAlteradoStrategyImpl(
            final @Qualifier("alterarNegativacaoEventProcessor") EventProcessor<BoletoNegativado> processor
    ){
    ...
    public EventType getStrategyType() {
        return EventType.BOLETO_ALTERADO;
    }
}
