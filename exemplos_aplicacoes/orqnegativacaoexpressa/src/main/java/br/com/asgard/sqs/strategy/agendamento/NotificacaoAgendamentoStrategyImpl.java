package br.com.asgard.sqs.strategy.agendamento;
...
@Component
public class NotificacaoAgendamentoStrategyImpl implements EventTypeStrategy {

    private final EventProcessor<BoletoNegativado> processor;

    public NotificacaoAgendamentoStrategyImpl(
            final @Qualifier("notificacaoAgendamentoNegativacaoProcessor") EventProcessor<BoletoNegativado> processor
    ){
    ...
    public EventType getStrategyType() {
        return EventType.AGENDAMENTO_INCLUSAO;
    }
}
