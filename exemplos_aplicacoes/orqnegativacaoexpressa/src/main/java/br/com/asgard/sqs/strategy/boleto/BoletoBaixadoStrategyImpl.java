...
@Component
public class BoletoBaixadoStrategyImpl implements EventTypeStrategy {

    private final EventProcessor<BoletoNegativado> processor;

    public BoletoBaixadoStrategyImpl(
            final @Qualifier("exclusaoNegativacaoEventProcessor") EventProcessor<BoletoNegativado> processor
    ){
    ...
    public EventType getStrategyType() {
        return EventType.BOLETO_BAIXADO;
    }
}
