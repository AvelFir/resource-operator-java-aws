...
@Component
public class AtualizacaoStatusNegativacaoStrategyImpl implements EventTypeStrategy {

    private final EventProcessor<BoletoNegativado> processor;

    public AtualizacaoStatusNegativacaoStrategyImpl(
            final @Qualifier("AtualizacaoStatusNegativacaoProcessor") EventProcessor<BoletoNegativado> processor
    ){
    ...
    public EventType getStrategyType() {
        return EventType.ATUALIZACAO_STATUS_NEGATIVACAO_DIVIDA;
    }
}
